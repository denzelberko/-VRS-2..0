<template>
  ...
  <div class="wel">
    <Welcome>This is a student project for MIE350 and should not be used for anything other than educational purposes.</Welcome>
  </div>

  <div class="info2">
    <b>Purpose</b><p>The purpose of this website is to create a unique tool to help users find their ideal vacation. Using a unique algorithm based on a variety of parameters, our team has created an effective method of finding your next destination.</p>
  </div>
  ...
  <div class="info2" ><b>Special Thanks</b><p>Thank you to Trivago and Tripadvisor for providing information as the basis for our destination data and Travelocity for flights.<br></p><info>“Trivago.com - compare hotel prices worldwide,” trivago, 2022. [Online]. Available: https://www.trivago.com/. [Accessed: 07-Dec-2022]. <br>"Tripadvisor," Tripadvisor.ca, 2022. [Online]. Available: https://www.tripadvisor.ca/. [Accessed: 07-Dec-2022]. <br>“Cheap flights: Find airline tickets, Flights &amp; Airfare: Travelocity,” Travelocity.ca, 2022. [Online]. Available: https://www.travelocity.ca/Flights. [Accessed: 07-Dec-2022].  </info>
  </div>

  <div class="info2">
    <info>What are you waiting for? Visit <a href="http://localhost:3000/#/recommendations/">recommendations</a>  to find your next adventure! </info>
  </div>
</div>
  </div>
